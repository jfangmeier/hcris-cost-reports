...
costreports <- 
  readRDS(url('https://github.com/jfangmeier/hcris-cost-reports/raw/master/data/costreports.rds'))
  # readRDS(url('https://www.dropbox.com/s/jvyw9v9gdpf0rea/costreports.rds?raw=1'))%>%
